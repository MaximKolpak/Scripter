...
{
    public class X32Channel : ConsoleInput 
    {
        public X32ChannelStrip Strip;

        public X32Channel()
        {
            Strip = new X32ChannelStrip();
            Strip.Parent = this;
            CreateMuteButton();
            CreateFader();
            CreateStereoLink();
        ...
        {
            Strip.Delay.Address = "/delay";
            Strip.Delay.Parent = this;
            Strip.Delay.Id = Id;

            Strip.Delay.On.Address = "/on";
            Strip.Delay.On.Parent = Strip.Delay;
            Strip.Delay.On.Id = Id;

            Strip.Delay.Time.Address = "/time";
            Strip.Delay.Time.Parent = Strip.Delay;
            Strip.Delay.Time.Id = Id;
        }
